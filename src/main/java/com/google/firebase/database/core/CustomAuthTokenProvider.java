...
public class CustomAuthTokenProvider extends JvmAuthTokenProvider {
    ...
    public CustomAuthTokenProvider(FirebaseApp firebaseApp, Executor executor, String apiKey, String refreshToken) {
    ...
    private static boolean isAfterGracePeriodStart(AccessToken accessToken) {
        return accessToken.getExpirationTime().getTime() - REFRESH_GRACE_PERIOD_MILLIS > System.currentTimeMillis();
    }
}
