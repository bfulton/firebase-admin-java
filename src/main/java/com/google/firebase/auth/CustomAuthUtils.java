...
import com.google.firebase.database.core.*;
...
public class CustomAuthUtils {
    ...
    public static void initializeWithCustomToken(String databaseUrl, String apiKey, String refreshToken) throws IOException {
    ...
    public static AccessToken signInWithCustomToken(String apiKey, String refreshToken) throws IOException {
        ...
        try {
            ...
            HttpRequest request = transport.createRequestFactory().buildPostRequest(url, new UrlEncodedContent(content));
    ...
    private static void setCustomAuthTokenProvider(FirebaseApp app, String apiKey, String refreshToken) {
        try {
            ...
            AuthTokenProvider authTokenProvider = new CustomAuthTokenProvider(app, executor, apiKey, refreshToken);
